	...
	IGameEventHandler<EquipmentHolsteredEvent>
{
	...
	public void Shoot()
	{
		...
		for (int i = 0; i < BulletCount; i++)
		{
			...
			foreach (var tr in GetShootTrace())
			{
				...
				//var damageFlags = EDamageFlags.None;
				//if (count > 0) damageFlags |= EDamageFlags.WallBang;
				//if (!Player.IsGrounded) damageFlags |= EDamageFlags.AirShot;
	...
	public bool CanShoot()
	{
		...
		// Weapon
		if (Equipment.Tags.Has("reloading") || Equipment.Tags.Has("equipping"))
			return false;
